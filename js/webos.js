...
var Window = function(url,title){
	...
	this.buttons = $('<div class="ui-widget-header buttons"><span class="close ui-icon ui-icon-close"></span><span class="max ui-icon ui-icon-plus"></span><span class="min ui-icon ui-icon-minus"></span></div>');
...
Window.prototype.show = function(){
	...
	this.pane.draggable({stack:".window"}).resizable({
		resize:function(){
			self.iframe.height(self.pane.height() - self.buttons.outerHeight());
		},
		minWidth: 229,
		minHeight: 316
	});
	
	this.iframe.height(this.pane.height() - this.buttons.outerHeight());
...
$(function(){
	...
	$('#wins').css('top',$('#status-bar').outerHeight());
